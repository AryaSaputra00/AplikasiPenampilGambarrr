 ...
 */
public class AplikasiPenampilanGambarButtonFullScreen extends javax.swing.JFrame {

    /**
     * Creates new form AplikasiPenampilanGambarButtonFullScreen
     */
    public AplikasiPenampilanGambarButtonFullScreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblglass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/download.jpg"))); // NOI18N
        ...
        lbljava.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/download (1).jpg"))); // NOI18N
        imagePanel.add(lbljava, "1");

        lblpost.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblpost.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/download (2).jpg"))); // NOI18N
        lblpost.setText("jLabel1");
        imagePanel.add(lblpost, "2");

        btnpanel.add(imagePanel);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable(){
            public void run(){
        AplikasiPenampilanGambarButtonFullScreen fullFrame = new AplikasiPenampilanGambarButtonFullScreen();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AplikasiPenampilanGambarButtonFullScreen().setVisible(true);
            }
        });
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AplikasiPenampilanGambarButtonFullScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
